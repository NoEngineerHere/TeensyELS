...
void Display::update(boolean driveMode, float pitch, boolean lock,
                     boolean enabled, boolean jogMode, boolean syncState) {
...
void Display::drawJogMode(boolean jogMode) {
#if ELS_DISPLAY == SSD1306_128_64
 

  if (jogMode == true) {
    
      m_ssd1306.setCursor(20, 0);
      m_ssd1306.setTextSize(3);
      m_ssd1306.setTextColor(WHITE);
      m_ssd1306.print("JOG");
    }
